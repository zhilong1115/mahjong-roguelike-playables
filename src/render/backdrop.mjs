...
export const BACKDROP_TONES = Object.freeze({
  default: { deep: [0.055, 0.161, 0.133], mid: [0.145, 0.373, 0.298], glow: [0.478, 0.792, 0.627] },
  east: { deep: [0.055, 0.165, 0.137], mid: [0.141, 0.384, 0.302], glow: [0.471, 0.808, 0.635] },
  south: { deep: [0.106, 0.153, 0.098], mid: [0.267, 0.353, 0.184], glow: [0.792, 0.796, 0.427] },
  west: { deep: [0.055, 0.106, 0.180], mid: [0.145, 0.251, 0.408], glow: [0.471, 0.635, 0.878] },
  boss: { deep: [0.157, 0.051, 0.055], mid: [0.376, 0.129, 0.118], glow: [0.898, 0.404, 0.318] },
  title: { deep: [0.047, 0.141, 0.118], mid: [0.133, 0.353, 0.282], glow: [0.510, 0.839, 0.663] },
});
