...
- 每个打赢的非最终关后进入百宝阁，标准局共 6 副、最多 5 家商店；通关后可选西圈加赛
...
- 现行 24 张五系功能卡由单一 Library 管理，标题页和局内都可打开「百牌谱」查看
...
正式版框架与 `0017` 六关短局切片已经落在 `src/`，但圈关结构仍是 `Proposed`，不是冻结规则。接下来按顺序做：真人试玩 5–8 分钟目标与商店频率 → 设计商店签筒 / 牌包 → 重标六关经济 → 单文件打包与平台 SDK 接入。详见 [`docs/09-progress.md`](docs/09-progress.md)。
